from U_shape_Transformer_for_Underwater_Image_Enhancement.utility.ptcolor import rgb2lab
from U_shape_Transformer_for_Underwater_Image_Enhancement.utility.Qnt import quantAB,quantL
import torch

class lab_Loss(torch.nn.Module):
